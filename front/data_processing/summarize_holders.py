...
INPUT = os.path.join(
    os.path.dirname(__file__), "..", "public", "processed", "transfers", "top_holders_history.json"
)
OUTPUT = os.path.join(
    os.path.dirname(__file__), "..", "public", "processed", "transfers", "top_holders_summary.json"
)
